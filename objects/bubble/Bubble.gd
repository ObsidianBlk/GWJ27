...
export (float, 0.1, 10000.0) var lift_per_second = 2.0
...
func _ready():
	...
	$Tween_Lift.interpolate_property(self, "global_position:y", self.global_position.y, self.global_position.y - lift_distance, lift_duration,Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween_Lift.start()
